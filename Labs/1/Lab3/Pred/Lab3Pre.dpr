...
Check: Boolean;
{
 ...
 Temp1 - the value of the intermediate value of the sum calculation,
 equal to the power -1;
 Temp2 - the value of the intermediate value of the sum calculation, 
 equal to the power of the variable x;
 Temp3 - the value of the intermediate value of the sum calculation, 
 equal to the denominator of the current term;
...
Begin
  ...
  Begin
    ...
    // Assigning Delta a value greater than E6 to enter the loop
    Delta := E6+1;

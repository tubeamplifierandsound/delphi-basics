...
Const
  N = 5;
  X: Array[1..N,1..N] of Real = ((1,3,4,10,11),(2,5,9,12,19),(6,8,13,18,20),(7,14,17,21,24),(15,16,22,23,25));
{
...
Begin
  ...
  // It is equal to 0, since it then changes to 1, and initially the transition to the diagonal in question occurs along the column
  iShift := 0;

  // Is equal to 1, since then it becomes equal to -1, and moving through the rows occurs initially to a smaller
  iDirect := 1;

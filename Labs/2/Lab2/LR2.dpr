...
Procedure InputCheck(Var Str: TInpStr; Var Input: Integer);

  // Ñonstant declaration section
  Const
    IntPart = MaxInt mod Trunc(2E9);
  {
...
Procedure ArrFill(Var RndArr, SArr, RvArr: TElArray);
  ...
  Begin
    ...
    Begin
      ...
      RndArr[i] := Random(RndTo-RndFrom)+1+RndFrom;
...
Procedure IsSorted(Var Arr: TElArray; Const Size: Integer; Var Sorted: AnswrStr);
...
Procedure Swap(Var El1, El2: Integer);
...
Procedure Sifting(Var ArrSift: TElArray; CNode: Integer; Var LstNode, NExper: Integer);
  ...
  Begin
    ...
    Sifted := False;
    While (Sifted = False) and (Child <= LstNode) do
    Begin

      // Choosing a descendant to compare with -  it should be the largest
      If (Child+1 <= LstNode) and (ArrSift[Child] < ArrSift[Child+1]) then
        Child := Child+1;
...
Procedure HeapSort(Arr: TElArray; Const Size: Integer; Var NExper: Integer; Var Sorted: AnswrStr);
...
Procedure SelectSort(Arr: TElArray; Const Size: Integer; Var NExper: Integer; Var Sorted: AnswrStr);
...
Procedure TableOutp(Var HeapInfo, SelectInfo: TArrType; Const Sizes: TSizez; Const N: Integer);
  ...
  Begin
    ...
    For i := 1 to N do
    Begin
      Write('| N = ', Sizes[i]:4, '     |  Sorted  | ', HeapInfo.Sort.ExperRes[i]:6, '       | ', HeapInfo.Sort.TheorRes[i]:6:0, '      | ');
      Writeln(SelectInfo.Sort.ExperRes[i]:10, '  | ', SelectInfo.Sort.TheorRes[i]:10:0, '   |');
      Writeln('|-------------------------|----------------------------|----------------------------|');
      Write('|      Is it sorted?      |             ', HeapInfo.Sort.ArrSorted[i], '            |             ');
      Writeln(SelectInfo.Sort.ArrSorted[i], '            |');
      Writeln('|-----------------------------------------------------------------------------------|');
      Write('| N = ', Sizes[i]:4, '     |  Random  | ', HeapInfo.Random.ExperRes[i]:6, '       | ', HeapInfo.Random.TheorRes[i]:6:0, '      | ');
      Writeln(SelectInfo.Random.ExperRes[i]:10, '  | ', SelectInfo.Random.TheorRes[i]:10:0, '   |');
      Writeln('|-------------------------|----------------------------|----------------------------|');
      Write('|      Is it sorted?      |             ', HeapInfo.Random.ArrSorted[i], '            |             ');
      Writeln(SelectInfo.Random.ArrSorted[i], '            |');
      Writeln('|-----------------------------------------------------------------------------------|');
      Write('| N = ', Sizes[i]:4, '     |  Reverse | ', HeapInfo.Reverse.ExperRes[i]:6, '       | ', HeapInfo.Reverse.TheorRes[i]:6:0, '      | ');
      Writeln(SelectInfo.Reverse.ExperRes[i]:10, '  | ', SelectInfo.Reverse.TheorRes[i]:10:0, '   |');
      Writeln('|-------------------------|----------------------------|----------------------------|');
      Write('|      Is it sorted?      |             ', HeapInfo.Reverse.ArrSorted[i], '            |             ');
      Writeln(SelectInfo.Reverse.ArrSorted[i], '            |');
      Writeln('|===================================================================================|');
      Writeln('|===================================================================================|');
    End;
  End;
